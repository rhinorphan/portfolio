      ...
      <div className='grid justify-center grid-cols-1 md:grid-cols-2 gap-10 font-semibold'>
        <div>
          ...
          <div>
            ...
            <img class="w-6 h-6 transition duration-300 group-hover:scale-110" src="https://cdn.jsdelivr.net/gh/PKief/vscode-material-icon-theme@main/icons/react.svg" alt="" />
            </a>
          </div>

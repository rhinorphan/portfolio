          ...
          <div className='flex flex-col justify-between items-center'>
            ...
            <div className='flex flex-col gap-2 justify-center items-center text-center text-xs md:text-sm mt-5'>
              ...
              <button className='border-2 border-gray-800 dark:border-gray-200 rounded-full p-2 w-fit hover:bg-gray-200 dark:hover:bg-gray-800'>
                <div className='flex flex-row justify-center items-center'>
                  <BiCodeAlt className='mr-2 text-[20px] md:text-[25px]'/>
                  <a href="https://github.com/rhinorphan/phat-landing-page" className='hover:bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 bg-clip-text hover:text-transparent duration-500'>{t('portfolio.btn-2')}</a>
                </div>
              </button>
            </div>
          </div>

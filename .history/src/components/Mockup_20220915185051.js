      ...
      <div className='grid justify-center grid-cols-1 md:grid-cols-2 gap-10 font-semibold items-center'>
        <div>
          ...
          <div className='flex flex-col justify-evenly items-center'>
            ...
            <div className='flex gap-4 justify-center items-center mx-auto my-2'>
              <a href="https://reactjs.org/" target="_blank" rel="noopener noreferrer" rel="noopener noreferrer" class="item flex flex-col items-center justify-around group">
              ...
              <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer" rel="noopener noreferrer" class="item flex flex-col items-center justify-around group">
              ...
              <a href="https://firebase.google.com/" target="_blank" rel="noopener noreferrer" rel="noopener noreferrer" class="item flex flex-col items-center justify-around group">
        ...
        <div>
          ...
          <div className='flex flex-col justify-around items-center'>
            ...
            <div className='flex gap-4 justify-center items-center mx-auto my-2'>
              <a href="https://nextjs.org/" target="_blank" rel="noopener noreferrer" rel="noopener noreferrer" class="item flex flex-col items-center justify-around group">
              ...
              <a href="https://www.typescriptlang.org/" target="_blank" rel="noopener noreferrer" rel="noopener noreferrer" class="item flex flex-col items-center justify-around group">
              ...
              <a href="https://www.sanity.io/" target="_blank" rel="noopener noreferrer" rel="noopener noreferrer" class="item flex flex-col items-center justify-around group">

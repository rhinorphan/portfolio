        ...
        <div>
          ...
          <div className='flex flex-col justify-between items-center'>
            ...
            <a href="https://www.axelcoaching.fr" target="_blank" rel="noopener noreferrer" className=''>
              ...
              <a href="/" className=''>
                <button className='border-2 border-gray-800 dark:border-gray-200 rounded-full p-2 w-fit hover:bg-gray-200 dark:hover:bg-gray-800 disable hover:bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 bg-clip-text hover:text-transparent duration-500'>
                  <div className='flex flex-row justify-center items-center'>

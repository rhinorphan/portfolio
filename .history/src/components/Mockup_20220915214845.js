      ...
      <div className='grid justify-center grid-cols-1 gap-10 font-semibold items-center max-w-2xl mx-auto'>
        <div>
          ...
          <div className='flex flex-col justify-between items-center'>
            ...
            <a href="https://www.axelcoaching.fr" target="_blank" rel="noopener noreferrer" className=''>
              <button className='border-2 border-gray-800 dark:border-gray-200 rounded-full p-2 w-fit hover:bg-gray-200 dark:hover:bg-gray-800 hover:bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 bg-clip-text hover:text-transparent duration-500'>
              ...
              <a href="/" className='border-2 border-gray-800 dark:border-gray-200 rounded-full p-2 w-fit hover:bg-gray-200 dark:hover:bg-gray-800'>
            ...
            <div className='flex flex-col gap-2 justify-center items-center text-center text-xs md:text-sm mt-5'>
              ...
              <button className='border-2 border-gray-800 dark:border-gray-200 rounded-full p-2 w-fit hover:bg-gray-200 dark:hover:bg-gray-800'>
                <div className='flex flex-row justify-center items-center'>
                  ...
                  <a href="https://github.com/rhinorphan/webmedia" target="_blank" rel="noopener noreferrer" className='hover:bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 bg-clip-text hover:text-transparent duration-500'>{t('portfolio.btn-2')}</a>
                </div>
              </button>
            </div>
          </div>

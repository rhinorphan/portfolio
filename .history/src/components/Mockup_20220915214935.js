      ...
      <div className='grid justify-center grid-cols-1 gap-10 font-semibold items-center max-w-2xl mx-auto'>
        <div>
          ...
          <div className='flex flex-col justify-between items-center'>
            ...
            <a href="https://www.axelcoaching.fr" target="_blank" rel="noopener noreferrer" className='border-2 border-gray-800 dark:border-gray-200 rounded-full p-2 w-fit hover:bg-gray-200 dark:hover:bg-gray-800 items-center'>

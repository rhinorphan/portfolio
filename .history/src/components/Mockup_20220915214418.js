      ...
      <div className='grid justify-center grid-cols-1 gap-10 font-semibold items-center max-w-2xl mx-auto'>
        <div>
          ...
          <div className='flex flex-col justify-between items-center'>
            ...
            <a href="https://www.axelcoaching.fr" target="_blank" rel="noopener noreferrer" className='hover:bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 bg-clip-text hover:text-transparent duration-500'>
